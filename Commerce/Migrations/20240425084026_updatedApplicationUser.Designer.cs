...
namespace Commerce.Migrations
{
    ...
    [Migration("20240425084026_updatedApplicationUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Commerce.Models.Identity.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Commerce.Models.Identity.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "022ab774-e6ff-4df6-8024-c4bfcabbca15",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEImBuKJa2rgPR6oDX+Vi3bvJ1VWLG5b5f1do1xH8xsmx6+05IB/GTJV5r6xJsZtN+Q==",
                            PhoneNumberConfirmed = false,
                            RefreshTokenExpiryTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            SecurityStamp = "d18002c7-dab3-4987-89a2-2b64b467bfc8",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "05d76503-ccc8-41ea-9eed-9a4b2d46ff67",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAECC/peuXbt+X4USlJbZ7ipVJl6D6PmNBNhYTPhYtI4TKgq4mptk99Mn8eTkPNq1orA==",
                            PhoneNumberConfirmed = false,
                            RefreshTokenExpiryTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            SecurityStamp = "73abfa0f-2707-4c1b-91e3-4bb7ce97c1f3",
                            TwoFactorEnabled = false,
                            UserName = "customer.smiledentist@gmail.com"
                        });
                });

            modelBuilder.Entity("Commerce.Models.Identity.BillingAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Commerce.Models.Identity.Address", b =>
                {
                    b.HasOne("Commerce.Models.Identity.ApplicationUser", "User")
                        .WithOne("Address")
                        .HasForeignKey("Commerce.Models.Identity.Address", "UserId")
            ...
            modelBuilder.Entity("Commerce.Models.Identity.BillingAddress", b =>
                {
                    b.HasOne("Commerce.Models.Identity.ApplicationUser", "User")
                        ...
                        .HasForeignKey("Commerce.Models.Identity.BillingAddress", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Commerce.Models.Identity.ApplicationUser", null)
                        .WithMany()
